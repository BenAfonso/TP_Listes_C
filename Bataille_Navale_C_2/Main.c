...
int main (void)
{
    ...
    Partie partie = creerPartie();          /* crée une partie appelée "partie" */
    
    Joueur j1 = joueur1(partie);            /* initialise une variable j1 correspondant au joueur 1 de la partie */
    Joueur j2 = joueur2(partie);            /* initialise une variable j2 correspondant au joueur 2 de la partie */
    ...
    if (estVide(flotte(j1)) == 1) {               /* si la flotte de j1 est vide */
