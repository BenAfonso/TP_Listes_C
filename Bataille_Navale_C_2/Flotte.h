...
Flotte ajoutBateau(Bateau b);     /* ajoute un bateau dans la listeBateaux lors du placement des bateaux */
Flotte suppBateau(Bateau b);      /* supprime un bateau dans la listeBateaux si ce même bateau est coulé */
